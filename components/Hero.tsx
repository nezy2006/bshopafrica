        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            >
              ...
              <div>
                <p className="text-xs text-gray-400 font-medium">Hosting from</p>
                <p className="text-sm font-bold text-black">$8<span className="text-gray-400 font-normal">/mo</span></p>
              </div>
            </motion.div>
