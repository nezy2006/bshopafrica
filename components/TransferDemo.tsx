  ...
  return (
    <div className="relative flex flex-col items-center gap-4 py-4">
      ...
      <motion.div
        ...
        className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center text-4xl shadow-[0_0_40px_rgba(34,197,94,0.6)]"
      >
        ✓
      </motion.div>
      <AnimatePresence>
...
const STEPS = [
  { id: 0, label: "You Submit",              time: "0–2s",  icon: "📝" },
  { id: 1, label: "Contact Registrar",       time: "2–4s",  icon: "📡" },
  { id: 2, label: "Domain Unlocks",          time: "4–6s",  icon: "🔓" },
  { id: 3, label: "Nameservers Update",      time: "6–8s",  icon: "🌐" },
  { id: 4, label: "Transfer Complete!",      time: "8–10s", icon: "🎉" },
];
