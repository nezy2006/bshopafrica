...
// Public/unauthenticated — used by the signup and checkout pages to confirm a
// referral code before it's applied. Never errors on a bad code; it just
// reports { valid: false } so a stale/mistyped code never blocks checkout.
